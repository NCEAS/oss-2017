...
Please note that Sierra Madre Apartments are non-smoking. The full regulations can be reviewed [here](https://github.com/NCEAS/oss-2017/blob/gh-pages/SierraMadreAptRegulations.pdf).  
...
- macOS: http://www.kyngchaos.com/software/qgis ; *Be sure to follow the order of installation of the different components*.
