...
- SSH client:
    ...
    - Mac and Linux users: You already have this installed. You can verify this by performing the following steps:
    
        1. Open Terminal.app (Applications -> Utilities -> Terminal)
        2. Type `which ssh` and type <RETURN>
        3. Check that the output is something like `/usr/bin/ssh` or some other path that ends in `ssh`.
